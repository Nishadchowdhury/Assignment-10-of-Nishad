    ...
    return (
        <div>
            ...
            <div className="flex flex-row gap-2">
                ...
                <button onClick={() => signInWithGithub()} className="bg-gray-700 text-white w-full p-2 flex flex-row justify-center gap-2 items-center rounded-sm hover:bg-gray-800 duration-100 ease-in-out">
